...
class Product(models.Model):
    ...
    #2 параметр это кол-во цифр после запятой
...
class Smartphone(Product):
    ...
    acсum_volume = models.CharField(max_length=255, verbose_name='Объем батареи')
    ram = models.CharField(max_length=255, verbose_name='Оперативная память')
    sd = models.BooleanField(default=True)
    sd_volume_max = models.CharField(max_length=255, verbose_name='Максимальный объем')
...
class Customer(models.Model):
    ...
    def __str__(self):
        return 'Покупатель {}'.format(self.user.first_name, self.user_last_name)
